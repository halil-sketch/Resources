...
self = {
    ...
    gridlist = {}
        ...
        self.window[1] = guiCreateWindow(434, 125, 393, 770, "Oscuri Roleplay İnterior", false)
        ...
        self.tab[2] = guiCreateTab("Oscuri", self.tabpanel[1])
	   ...
	   guiGridListSetItemText(self.gridlist[1], 21, 1, "İd 9: Garaj", false, false)
	   guiGridListSetItemText(self.gridlist[1], 22, 1, "İd 10 : Garaj", false, false)
	   guiGridListSetItemText(self.gridlist[1], 23, 1, "İd 163: Garaj", false, false)
	   guiGridListSetItemText(self.gridlist[1], 24, 1, "İd 165: Ofis", false, false)
